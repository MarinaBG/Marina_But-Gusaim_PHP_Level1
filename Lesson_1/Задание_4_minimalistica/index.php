...
<body>
	<div id="content">
        ...
        $list.="<li><a href='#'>contact</a></li></ul>";
        echo $list;
        ?>
		<!-- <ul id="menu">
			<li><a href="#">home</a></li>
		...
		<div id="footer">
			<p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a><?php echo ", $date" ?><!-- добавлен год --></p>
		</div>	
	</div>
</body>
</html>